...
function App() {
  ...
  return <AuroraBackground className="app-shell">
    <header className="topbar"><div className="brand"><span className="brand-mark">CL</span><div><p>Clinical Lab</p><span>Gestión de laboratorio</span></div></div><div className={`connection-status ${apiOnline ? 'is-online' : ''}`}><span />{apiOnline ? 'API conectada' : 'API sin conexión'}</div></header>
